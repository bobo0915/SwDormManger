  ...
  <div class="div1">
    ...
    <html:form action="baseData/med.do" method="post" focus="name" enctype="multipart/form-data" onsubmit="return save();">
      ...
      <table border="0" align="center" width="450">
        <tr>
          <td align="right"><bean:message key="medicine.medNo" />：</td>
        ...
        <tr>
          <td align="right"><bean:message key="medicine.storage.count" />：</td>
          <td align="left"><html:text property="medCount"/></td>
        </tr>
        <tr>
          <td align="right"><bean:message key="medicine.category" />：</td>
          <td align="left">
        ...
        <tr>
          <td align="right"><bean:message key="medicine.photo" />：</td>
          <td align="left">
        ...
        <tr>
          <td align="right"><bean:message key="medicine.description" />：</td>
