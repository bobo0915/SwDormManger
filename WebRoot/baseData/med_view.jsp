  	...
  	<logic:present name="med" scope="request">
       ...
       <tr bgcolor="#FFFFFF" >
        ...
        <tr bgcolor="#FFFFFF" >
          ...
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.medNo" />：</td>
          <td align="left"><bean:write name="med" property="medNo"/></td>
        </tr>
        <tr bgcolor="#FFFFFF" >
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.name" />：</td>
          <td align="left" colspan="3"><bean:write name="med" property="name"/></td>
        </tr>
        <tr bgcolor="#FFFFFF" >
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.storage.count" />：</td>
          <td align="left"><bean:write name="med" property="medCount"/></td>
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.req.count" />：</td>
          <td align="left"><bean:write name="med" property="reqCount"/></td>
        </tr>
        <tr bgcolor="#FFFFFF" >
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.price" />：</td>
          <td align="left"><bean:write name="med" property="price"/></td>
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.category" />：</td>
          <td align="left"><bean:write name="med" property="category.name"/></td>
        </tr>
        <tr bgcolor="#FFFFFF" >
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.factoryAdd" />：</td>
          <td align="left" colspan="3"><bean:write name="med" property="factoryAdd"/></td>
        </tr>
        <tr bgcolor="#FFFFFF"  height="40">
          <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.description" />：</td>
